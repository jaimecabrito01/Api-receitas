...
public interface ReceitaRepository extends JpaRepository<Receita, Long>{
  ...
  @Query("SELECT new com.example.api.dto.ReceitaResponseDTO(r.id, r.titulo, r.descricao, r.imagem, r.categoria, r.ingredientes, r.passos, r.createdAt, r.user.nome) " +
           "FROM Receita r")
